...
for app in apiman apiman-gateway elasticsearch-v1 example-message-consumer example-message-producer fabric8-camel fabric8-ipaas kafka message-broker message-gateway zookeeper ; do
...
for app in chat-irc chat-letschat chat-slack logging management metrics packages social; do
